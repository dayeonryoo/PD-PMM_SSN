...
public:
    ...
    T compute_Lagrangian(const Vec& x_new, const Vec& v_new, const Vec& y2_new);
    Vec compute_grad_Lagrangian(const Vec& x_new, const Vec& v_new, const Vec& y2_new);
    ...
    T backtracking_line_search(const Vec& x_curr, const Vec& v_curr, const Vec& y2_curr,
